...
<div class="appointment-container">
  ...
  >
    ...
    <div
      ...
      "
    >
      <h2 style="font-size: 16px; font-weight: bold; color: #00a59e">
        Clinic Name
      </h2>
    </div>
    <!-- Patient Information -->
      ...
      >
        ...
        >
          <div style="display: flex; margin: 0">
            <span style="color: #69717d; font-weight: 500; font-size: 8px"
              >Name:</span
            >
            <span style="color: #11181c; font-weight: 600; font-size: 8px"
              ><?= $appointment['patient'] ? $appointment['patient']['full_name'] : "" ?></span
            >
          </div>
          ...
          <div style="display: flex; justify-content: end; margin: 0">
            ...
            >
            <span style="color: #11181c; font-weight: 600; font-size: 8px"
              ><?= $appointment['patient'] ? $appointment['patient']['gender'] : "" ?></span
            >
          </div>
          <div style="display: flex; margin: 0">
            <span style="color: #69717d; font-weight: 500; font-size: 8px"
            ...
            >
            <span style="color: #11181c; font-weight: 600; font-size: 8px"
              ><?= $appointment['patient'] ? $appointment['patient']['contact_number'] : "" ?></span
            >
          </div>
          <div style="display: flex; justify-content: end; margin: 0">
            <span style="color: #69717d; font-weight: 500; font-size: 8px"
            ...
            >
            <span style="color: #11181c; font-weight: 600; font-size: 8px"
              ><?= $appointment['patient'] ? $appointment['patient']['user']['email'] : "" ?></span
            >
          </div>
        </div>
        <div style="margin-top: 8px">
          ...
          >
            ...
            >
            <span style="color: #11181c; font-weight: 600; font-size: 8px"
              ><?= $appointment['patient'] ? $appointment['patient']['address'] : "" ?></span
            >
          </div>
        </div>
      </div>
          ...
          <div style="display: flex; margin: 0">
            ...
            <span
              style="
                ...
                text-align: end;
              "
              ><?= $appointment['appointment_number'] ?></span
            >
          </div>
          <div style="display: flex; justify-content: end; margin: 0">
            <span style="color: #69717d; font-weight: 500; font-size: 8px"
            ...
            >
            <span style="color: #11181c; font-weight: 600; font-size: 8px"
              ><?= $appointment['doctor'] ? $appointment['doctor']['username'] : "" ?></span
            >
          </div>
          <div style="display: flex; margin: 0">
            <span style="color: #69717d; font-weight: 500; font-size: 8px"
